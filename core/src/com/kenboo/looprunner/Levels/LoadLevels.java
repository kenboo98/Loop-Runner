...
public class LoadLevels {
    ...
    public final static int N_LEVELS = 13;
    public final static int[] coinNum = {2, 2, 3, 3, 3, 3, 4, 3, 5, 5, 3, 3, 5};//number of coins for each level
    public static ActorManager getLevel(int level, ShapeRenderer renderer){
        switch (level){
            ...
            case 12:
                return Level12.getLevel(renderer);
            case 13:
                return Level13.getLevel(renderer);
            default:return null;
        }
    }
