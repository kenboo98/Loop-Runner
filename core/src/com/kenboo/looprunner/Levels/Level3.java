...
public class Level3 {
    public static ActorManager getLevel(ShapeRenderer renderer) {
        ...
        currentActor.addAction(Actions.parallel(Actions.moveTo(0, 2000, 10), Actions.rotateBy(100, 10)));
        ...
        currentActor.addAction(Actions.parallel(Actions.moveTo(1080, 1365, 8), Actions.rotateBy(360, 10)));
        bm.addActor(currentActor);

        currentActor = new Block(renderer,1920,1080,200,420);
        currentActor.addAction(Actions.parallel(Actions.moveTo(-200, -200, 10), Actions.rotateBy(180, 10)));
        bm.addActor(currentActor);


        //add coins
        currentActor = new Coin(-100,1000,renderer);
        currentActor.addAction(Actions.sequence(Actions.delay(5), Actions.moveTo(1000, 1000, 5)));
        bm.addActor(currentActor);
        ...
        currentActor.addAction(Actions.sequence(Actions.delay(7), Actions.moveTo(2000, 2000, 3)));
        bm.addActor(currentActor);
