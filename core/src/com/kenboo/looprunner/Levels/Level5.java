...
public class Level5 {
    public static ActorManager getLevel(ShapeRenderer renderer) {
        ...
        currentActor.addAction(new SequenceAction(Actions.moveBy(0, 2500, 7),Actions.moveBy(0, -2500, 7)));
        bm.addActor(currentActor);

        currentActor = new Block(renderer, 216, 0, 216, 400);
        currentActor.addAction(new SequenceAction(Actions.delay(2.5f),Actions.moveBy(0, 2500, 7),Actions.moveBy(0, -2500, 7)));
        bm.addActor(currentActor);

        currentActor = new Block(renderer, 432, 0, 216, 400);
        currentActor.addAction(new SequenceAction(Actions.delay(5),Actions.moveBy(0, 2500, 7),Actions.moveBy(0, -2500, 7)));
        bm.addActor(currentActor);

        currentActor = new Block(renderer, 648, 0, 216, 400);
        currentActor.addAction(new SequenceAction(Actions.delay(7.5f),Actions.moveBy(0, 2500, 7),Actions.moveBy(0, -2500, 7)));
        bm.addActor(currentActor);

        currentActor = new Block(renderer, 864, 0, 216, 400);
        currentActor.addAction(new SequenceAction(Actions.delay(10),Actions.moveBy(0, 2500, 7),Actions.moveBy(0, -2500, 7)));
        bm.addActor(currentActor);
        ...
        currentActor.addAction(new SequenceAction(Actions.delay(12),Actions.moveTo(1120,0,7, Interpolation.circle)));
        bm.addActor(currentActor);
