...
public class Level5 {
    ...
    public static ActorManager getLevel(ShapeRenderer renderer) {
        ...
        currentActor.addAction(
                Actions.sequence(Actions.moveBy(0, 2500, 7),
                Actions.moveBy(0, -2500, 7)));
        ...
        currentActor.addAction(Actions.sequence(
                Actions.delay(8),
                Actions.moveTo(1120, 0, 10, Interpolation.circle)));
        bm.addActor(currentActor);

        currentActor = new Coin(-40, 1200, renderer);
        currentActor.addAction(Actions.sequence(
                Actions.delay(14),
                Actions.moveTo(1120, 0, 7, Interpolation.circle)));
        bm.addActor(currentActor);
